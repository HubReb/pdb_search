...
- [X] T001 Confirm working tree is on branch `002-ux-polish` and clean; verify `uv sync --all-extras` succeeds and `uv run pytest` passes the existing 001-era suite end-to-end (baseline parity check before adding any 002 changes).
