...
For a reverse-engineered description of the *legacy* stack as it was before this modernization (useful when reading historical commits), see `docs/architecture.md`.
...
<!-- SPECKIT START -->
**Active feature**: `specs/001-modernize-stack/` — Modernize the Stack. See [plan.md](specs/001-modernize-stack/plan.md) for the implementation plan, [research.md](specs/001-modernize-stack/research.md) for framework decisions, [data-model.md](specs/001-modernize-stack/data-model.md) for the schema/DTO design, [contracts/cli-commands.md](specs/001-modernize-stack/contracts/cli-commands.md) for the CLI grammar, and [quickstart.md](specs/001-modernize-stack/quickstart.md) for install/run instructions. Work on this feature happens on branch `001-modernize-stack`.
<!-- SPECKIT END -->
