...
**Active feature**: `specs/001-modernize-stack/` — Modernize the Stack. See [plan.md](specs/001-modernize-stack/plan.md) for the implementation plan, [research.md](specs/001-modernize-stack/research.md) for design decisions, [data-model.md](specs/001-modernize-stack/data-model.md) for the schema and DTOs, [contracts/cli-commands.md](specs/001-modernize-stack/contracts/cli-commands.md) for the CLI contract, and [quickstart.md](specs/001-modernize-stack/quickstart.md) for what's new for the user.
<!-- SPECKIT END -->
