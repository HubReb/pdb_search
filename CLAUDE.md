...
Session fixtures live in `tests/conftest.py` (`postgresql_proc_fixture`, `ephemeral_db_url`); the canonical seed dataset is `tests/fixtures/seed_papers.SEED_PAPERS`. Bench harness lives under `tests/benchmarks/`.
...
<!-- SPECKIT START -->
**Active feature**: `specs/001-modernize-stack/` — Modernize the Stack. See [plan.md](specs/001-modernize-stack/plan.md) for the implementation plan and [research.md](specs/001-modernize-stack/research.md) for design decisions.
<!-- SPECKIT END -->
